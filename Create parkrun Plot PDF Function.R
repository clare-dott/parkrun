...
#Run function for various csv files
PlotPDF("Clare2.csv", "Clare.pdf", 20, 40)
PlotPDF("Craig.csv", "Craig.pdf", 20, 40)
PlotPDF("Mother.csv", "Mother.pdf", 35, 55)
PlotPDF("Father.csv", "Father.pdf", 20, 45)
PlotPDF("Greg.csv", "Greg.pdf", 18, 40)
PlotPDF("Mumsy.csv", "Mumsy.pdf", 35, 60)
PlotPDF("Daddles.csv", "Daddles.pdf", 25, 50)
